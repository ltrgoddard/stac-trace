...
View your hotspots on an interactive 3D globe:
...
Features:
- 🌍 **3D Globe projection** with satellite imagery background
- 🎯 **Interactive clusters** showing merged surveillance hotspots
- 📊 **Real-time stats** for total images and hotspots
- 🖱️ **Click clusters** for detailed information
- 📍 **Color-coded** by surveillance intensity

The map automatically loads `data/hotspots.geojson` generated by the pipeline.
